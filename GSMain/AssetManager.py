...
AssetName = "ANM_SCENECHAR_e001s01d01v001_Chris.Fbx"


def AssetNameDeterminant(AssetName):
    ...
    AssetLocation = AssetType[AssetPrefix]
    return AssetLocation


AssetLocation = AssetNameDeterminant(AssetName)

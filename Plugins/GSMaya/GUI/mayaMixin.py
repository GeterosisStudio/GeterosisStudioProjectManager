...
class MayaQWidgetDockableMixin(MayaQWidgetBaseMixin):
    ...
    def setDockableParameters(self, dockable=None, floating=None, area=None, allowedArea=None, width=None, height=None,
                ...
                if floating == True or area == None:
                    ...
                    if self.parent() is None or self.parent() == omui.MQtUtil.mainWindow():
                        ...
                        workspaceControlName = cmds.workspaceControl(workspaceControlName, label=self.windowTitle(),
                                                                     ...
                                                                     dockToMainWindow=(area, False), initialWidth=width,
                                                                     initialHeight=height, requiredPlugin=plugins,
                        ...
                        while parent is not None:
                            ...
                            if cmds.workspaceControl(dockToWorkspaceControlName, q=True, exists=True):
                                workspaceControlName = cmds.workspaceControl(workspaceControlName,
                                                                             ...
                                                                             loadImmediately=True, dockToControl=(
                                    dockToWorkspaceControlName, area), initialWidth=width, initialHeight=height,

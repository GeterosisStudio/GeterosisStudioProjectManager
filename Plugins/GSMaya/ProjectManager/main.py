...
def main(batch = None):
    ...
    try:
        ...
        from Plugins.GSMaya.GUI.Windows.PromoteTo.PromoteToWindow import PromoteToWindow
    ...
    from Plugins.GSMaya.GUI.Windows import MainMayaWindow as MainMayaWindow
